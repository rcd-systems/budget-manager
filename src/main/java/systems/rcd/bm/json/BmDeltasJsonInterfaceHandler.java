...
public class BmDeltasJsonInterfaceHandler
    implements RcdJettyHandler
{
        ...
        throws IOException
    {
        ...
        final double initialAmount = RcdContext.getService( BmModelService.class ).findInitialAmount( year, month, account );
        final List<Entry<String, Integer>> deltas = RcdContext.getService( BmModelService.class ).findDeltas( year, month, account );
