    ...
    public RcdJsonArray convert( final Collection<Transfer> transfers )
    {
        ...
        if ( transfers != null )
        {
            transfers.stream().map( transfer -> {
                ...
                transferJsonObject.put( "type", transfer.getType().toString() );
                transferJsonObject.put( "date", transfer.getDate().toString() );
                transferJsonObject.put( "amount", transfer.getAmount() );
                transferJsonObject.put( "currency", transfer.getCurrency().toString() );
                ...
                {
                    transferJsonObject.put( "srcAccount", transfer.getSourceAccount().toString() );
                }
                if ( transfer.getSourceDate() != null )
                {
                    transferJsonObject.put( "srcDate", transfer.getSourceDate().toString() );
                }
                if ( transfer.getTargetAccount() != null )
                {
                    transferJsonObject.put( "tgtAccount", transfer.getTargetAccount().toString() );
                }
                if ( transfer.getTargetDate() != null )
                {
                    transferJsonObject.put( "tgtDate", transfer.getTargetDate().toString() );
                }
